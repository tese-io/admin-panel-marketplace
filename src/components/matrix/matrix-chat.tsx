...
import { Avatar, IconButton, Text, clx } from "@medusajs/ui"
import {
  MatrixClient,
  MatrixEvent,
  MsgType,
...
/**
 * Single-room chat pane for the admin support inbox: full timeline with
 * read-only commerce cards + a text/file composer.
 */
